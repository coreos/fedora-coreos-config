...
[source,bash]
----
$ fcct --pretty --strict fcct-autologion.yaml --output autologin.ign
----
...
[source,bash]
----
[core@tutorial ~]$ systemctl status zincati.service | cat
...
[source,bash]
----
[core@tutorial ~]$ journalctl -t ignition | cat
...
----
