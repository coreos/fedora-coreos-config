...
* website at https://coreos.fedoraproject.org/
* Twitter https://twitter.com/coreos[@coreos] (specific to CoreOS and
containers) and https://twitter.com/fedora[@fedora] (all Fedora and
other relevant news)
...
Fedora CoreOS is under active development and there are currently no
downloads available. However, you will be able to download the images
from one canonical location via the CoreOS and Fedora websites. The
discussions around this development will happen on our community
channels.
