...
Fedora CoreOS is the official successor to Container Linux, but it
is not a drop-in replacement.
The Container Linux project has an https://coreos.com/os/eol/[end-of-life timeline]
sprawling across 2020, allowing remaining users to perform migrations.
...
last Fedora Atomic Host release was version 29, and it already reached
end-of-life.
...
production. For more about this, please refer to https://docs.fedoraproject.org/en-US/fedora-coreos/running-containers/[documentation].
