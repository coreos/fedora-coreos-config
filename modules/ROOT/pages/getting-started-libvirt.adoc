...
NOTE: `virt-install` on Fedora 36 required additional steps:  Give proper selinux permission to ign-file: `chcon -t svirt_home_t /path/to/example.ign` and add `--network bridge=virbr0`
