...
## kola:
##   exclusive: false
##   description: Verify that `kubernetes_file_t` labeled 
##     files can be read by systemd, also check if the `kube-env` 
##     service started successfully and the service wrote to the 
